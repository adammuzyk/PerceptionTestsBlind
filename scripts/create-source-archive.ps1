param(
    ...
    [string]$ArchivePrefix = "PerceptionTests_source"
)
...
$stagingRoot = Join-Path ([System.IO.Path]::GetTempPath()) ("PerceptionTests-archive-" + [System.Guid]::NewGuid().ToString("N"))
[System.IO.Directory]::CreateDirectory($stagingRoot) | Out-Null

try {
    Copy-ExportContent -RepoRoot $repoRoot -DestinationRoot $stagingRoot -ProfileName "source"
    ...
    Get-ExportProfileSummary -ProfileName "source" | Format-List
}
finally {
